<script lang="ts">
	import LandingImage from '$lib/images/landing.jpg';
</script>
...
<style lang="postcss">
	...
	.link-container > div:nth-child(4) {
		grid-column: 4 / 5;
		grid-row: 1 / 2;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(5) {
		grid-column: 1 / 2;
		grid-row: 2 / 3;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(6) {
		grid-column: 2 / 3;
		grid-row: 2 / 3;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(7) {
		grid-column: 3 / 4;
		grid-row: 2 / 3;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(8) {
		grid-column: 4 / 5;
		grid-row: 2 / 3;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(9) {
		grid-column: 1 / 2;
		grid-row: 3 / 4;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(10) {
		grid-column: 2 / 3;
		grid-row: 3 / 4;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(11) {
		grid-column: 3 / 4;
		grid-row: 3 / 4;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(12) {
		grid-column: 4 / 5;
		grid-row: 3 / 4;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(13) {
		grid-column: 1 / 2;
		grid-row: 4 / 5;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(14) {
		grid-column: 2 / 3;
		grid-row: 4 / 5;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(15) {
		grid-column: 3 / 4;
		grid-row: 4 / 5;
		z-index: 100;
	}
	...
	.link-container > div:nth-child(16) {
		grid-column: 4 / 5;
		grid-row: 4 / 5;
		z-index: 100;
	}
